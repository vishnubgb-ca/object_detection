...
def transform_data():
    ...
    train_dataset = CustomDataset(os.path.join(os.getcwd(),"object_detection_data/train/images"),os.path.join(os.getcwd(),"object_detection_data/train/annotations"),IMAGE_WIDTH, IMAGE_HEIGHT,classes,get_train_transform())
    valid_dataset = CustomDataset(os.path.join(os.getcwd(),"object_detection_data/valid/images"),os.path.join(os.getcwd(),"object_detection_data/valid/annotations"),IMAGE_WIDTH, IMAGE_HEIGHT,classes,get_valid_transform())
